...
public class ProtectionList : InventoryManagemenrBase
{
    ...
    private ProtectionList()
    {
        ...
        Builder = InventoryCleanupCommon.CreateCleanupHeaderBuilder()
            .Section(Name.Loc())
            .TextWrapped("AutoRetainer won't sell, desynthese, discard or hand in to Grand Company these items, even if they are included in any other processing lists.".Loc())
